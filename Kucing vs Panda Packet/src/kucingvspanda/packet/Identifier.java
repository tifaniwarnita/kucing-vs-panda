...
public class Identifier {
    ...
    public static final int ADD_PLAYER_COUNT = 16; //roomname 
    ...
    public static final int LEAVE_GAME_SUCCESS = 22; //list<roominfo>
    public static final int PLAYER_LEAVE = 23; //playername
    public static final int DEC_PLAYER_COUNT = 24; //roomname
    public static final int WIN = 25; //x + y + win type
    public static final int BOARD_FULL = 26;
    // kapan kapan kasih tau player leave game saat kurang dari 3
    public static final int HIGHSCORE = 27; //highscore list
